...
export class Init_1707781446343 implements MigrationInterface {
    name = 'Init_1707781446343'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "consultation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" character varying NOT NULL, "date" character varying NOT NULL, "linkpay" text, "professionalId" uuid, "activityId" uuid, "userId" uuid, CONSTRAINT "PK_5203569fac28a4a626c42abe70b" PRIMARY KEY ("id"))`);
