...
export class InitI1706722018199 implements MigrationInterface {
    name = 'InitI1706722018199'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "consultation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "price" character varying NOT NULL, "status" character varying NOT NULL, "date" character varying NOT NULL, "linkpay" text, "professionalId" uuid, CONSTRAINT "PK_5203569fac28a4a626c42abe70b" PRIMARY KEY ("id"))`);
